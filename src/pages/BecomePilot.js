...
function BecomePilot() {
  return (
    <div className="page-content become-pilot-page">
      ...
      <section className="hero bp-hero" style={{
        width: '100%',
        padding: '60px 20px',
        margin: '0',
      ...
      <section className="bp-blue-section" style={{
        ...
        <div className="bp-grid" style={{
          ...
          <div className="bp-grid-item bp-text-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px 40px', margin: '20px 0'}}>
          ...
          <div className="bp-grid-item bp-image-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'flex-end'}}>
            <img src="/images/7100d5_2ca09ef740484ab3936befd719dda6ef~mv2.avif" alt="Pilot training" loading="lazy" decoding="async" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
          </div>

          {/* Expert Support Section */}
          <div className="bp-grid-item bp-image-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <img src="/images/dreamstime_29653134.avif" alt="Pilot training support" loading="lazy" decoding="async" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
          </div>
          <div className="bp-grid-item bp-text-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px 40px', margin: '20px 0'}}>
      ...
      <div className="bp-white-section" style={{backgroundColor: 'white', width: '100%', padding: '40px 20px', margin: '20px 0'}}>
        <div style={{maxWidth: '1200px', margin: '0 auto', textAlign: 'center'}}>
          ...
          <div className="bp-pathways" style={{display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap'}}>
            <Link to="/the-easa-route" className="pathway-card bp-pathway-card" style={{
              padding: '25px 20px',
            ...
            <Link to="/the-faa-route" className="pathway-card bp-pathway-card" style={{
              padding: '25px 20px',
              backgroundColor: 'rgba(0,123,255,0.05)',
              borderRadius: '12px',
              boxShadow: '0 6px 20px rgba(0,123,255,0.2)',
            ...
            <Link to="/the-icao-route" className="pathway-card bp-pathway-card" style={{
              padding: '25px 20px',
              backgroundColor: 'rgba(0,123,255,0.05)',
              borderRadius: '12px',
              boxShadow: '0 6px 20px rgba(0,123,255,0.2)',
      ...
      <div className="bp-blue-section" style={{
        backgroundColor: '#cce0ff',
        width: '100%',
        padding: '40px 20px',
        margin: '20px 0'
        ...
        <div className="bp-grid" style={{
          ...
          <div className="bp-grid-item bp-image-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <img src="/images/dreamstime_l_217194379.avif" alt="Private pilot training" loading="lazy" decoding="async" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
          </div>

          <div className="bp-grid-item bp-image-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <img src="/images/dreamstime_l_69853862.avif" alt="Advanced pilot training" loading="lazy" decoding="async" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
          </div>
          <div className="bp-grid-item bp-text-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px 40px', margin: '20px 0'}}>
          ...
          <div className="bp-grid-item bp-image-item" style={{textAlign: 'center', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
            <img src="/images/dreamstime_xxl_157001658_edited.avif" alt="ATP training" loading="lazy" decoding="async" style={{width: '100%', height: '100%', objectFit: 'cover'}} />
          </div>
